...
class Router
{
  ...
  std::vector<RouteTableEntry>::iterator longest_prefix_match_( uint32_t dst_ip );

  static int longest_prefix_( uint32_t dst_ip, uint32_t route_prefix, uint8_t prefix_length );
